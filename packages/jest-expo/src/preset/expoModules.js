  ...
  NativeUnimoduleProxy: {
    exportedMethods: {
      ...
      mock: {
        ...
        ExpoAmplitude: [
          { key: 0, argumentsCount: 1, name: 'setUserIdAsync' },
          { key: 1, argumentsCount: 1, name: 'logEventAsync' },
          { key: 2, argumentsCount: 2, name: 'logEventWithPropertiesAsync' },
          { key: 3, argumentsCount: 1, name: 'initializeAsync' },
          { key: 4, argumentsCount: 1, name: 'setTrackingOptionsAsync' },
          { key: 5, argumentsCount: 1, name: 'setUserPropertiesAsync' },
          { key: 6, argumentsCount: 2, name: 'setGroupAsync' },
        ...
        ExpoNotificationScheduler: [
          ...
          { key: 1, argumentsCount: 0, name: 'getAllScheduledNotificationsAsync' },
          { key: 2, argumentsCount: 3, name: 'scheduleNotificationAsync' },
          { key: 3, argumentsCount: 1, name: 'cancelScheduledNotificationAsync' },
        ],
        ...
        ExponentMediaLibrary: [
          ...
          { key: 12, argumentsCount: 2, name: 'getAssetInfoAsync' },
